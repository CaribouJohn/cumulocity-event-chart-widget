...
const bundle = series(
    ...
    function createZip() {
        return src('./dist/widget/**/*')
            ...
            .pipe(zip('cumulocity-event-chart-widget_v1.0.1.zip'))
            .pipe(dest('dist/'))
    }
)
...
exports.default = series(clean, compile, bundle, async function success() {
    ...
    console.log("Runtime Widget Output (Install in the browser): dist/cumulocity-event-chart-widget_v1.0.1.zip");
